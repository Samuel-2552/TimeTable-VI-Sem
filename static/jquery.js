$(document).ready(function() {
  ...
  var typed = new Typed('#typed-text', {
    strings: ["Notification: \"AI is not just a technology, it's a philosophy. It's a way of approaching problems that are too complex for humans to solve alone.\" - Kai-Fu Lee"],
    typeSpeed: 30,
    backSpeed: 20,
    // loop: true
  }); 
